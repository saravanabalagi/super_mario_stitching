...
def affineStitch(imageLeft, imageRight):
    ...
    imageCorrespondence = cv2.drawMatches(imageLeft, kpLeft, imageRight, kpRight, [goodMatches[np.argmin(losses)]],
                                          None, flags=2)
    ...
    print('Translation: {:5d} | keypoints: {:5d} {:5d} | Matches: {:5d} / {:5d}'.format(requiredWidth, len(kpLeft),
